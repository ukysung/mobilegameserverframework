...
_CHAR_INFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='curr_gold', full_name='msg.char_info.curr_gold', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='curr_sera', full_name='msg.char_info.curr_sera', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='equip_weapon', full_name='msg.char_info.equip_weapon', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='equip_head', full_name='msg.char_info.equip_head', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='equip_body', full_name='msg.char_info.equip_body', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='equip_wings', full_name='msg.char_info.equip_wings', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skill_slot1', full_name='msg.char_info.skill_slot1', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skill_slot2', full_name='msg.char_info.skill_slot2', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skill_slot3', full_name='msg.char_info.skill_slot3', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='skill_slot4', full_name='msg.char_info.skill_slot4', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='last_playtime', full_name='msg.char_info.last_playtime', index=14,
