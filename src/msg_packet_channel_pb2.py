...
# source: msg_packet_channel.proto
...
enter_town_req = _reflection.GeneratedProtocolMessageType('enter_town_req', (_message.Message,), dict(
  ...
  __module__ = 'msg_packet_channel_pb2'
