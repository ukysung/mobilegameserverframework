...
_ERR_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='err_server_user_user_id_required', index=3, number=11101,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='err_client_user_user_id_required', index=7, number=21101,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
